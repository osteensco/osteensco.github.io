        ...
        <div class="w-full">
            <div class="container mx-auto mt-10">
                <h3 class="text-4xl my-10 flex justify-center px-5 items-center space-x-4">
                    <a href="./index.html" class="hover:text-blue-500 transition-all">Scott Osteen</a>
                </h3>
                <ul class="flex justify-center px-5 items-center space-x-4">
                    ...
                    <a title="Blog" role="button" class="inline-flex items-center border border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white font-medium rounded-md px-4 py-2 transition-all" href="./blog.html">
                        Blog
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="ml-2 bi bi-pencil-square" viewBox="0 0 16 16">
